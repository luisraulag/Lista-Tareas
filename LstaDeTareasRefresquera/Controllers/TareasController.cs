...
using ListaDeTareasRefresquera.Data;
using ListaDeTareasRefresquera.Models;

namespace ListaDeTareasRefresquera.Controllers
{
    public class TareasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdTarea,NombreTarea,FechaTarea,EstatusTarea")] Tarea tarea)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTarea,NombreTarea,FechaTarea,EstatusTarea")] Tarea tarea)
        {
            if (id != tarea.IdTarea)
            {
                return NotFound();
